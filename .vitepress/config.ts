    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'kubernetes 🟡', link: '/container/k8s/home/overview', activeMatch: '/container/k8s'},
        ]
      },
      {
        text: 'Vue',
      ...
      "/container/k8s/": [
        {
          ...
          items: [
            { text: 'Home', 
              collapsed: true,
              items: [
                  { text: 'Overview', link: '/container/k8s/home/overview' },
                  { text: 'Available Documentation Versions', link: '/container/k8s/home/doc_version' },
                ] 
            },
            { text: 'Getting started', 
              collapsed: true,
              items: [
                  { text: 'Overview', link: '/container/k8s/get_started/overview' },
                  { text: 'Learning environment', link: '/container/k8s/task/install_tool/overview' },
                  { text: 'Production environment', 
                    collapsed: true,
                    items: [
                        { text: 'Overview', link: '/container/k8s/get_started/prod_env/overview' },
                        { text: 'Container Runtimes', link: '/container/k8s/get_started/prod_env/runtime' },
                        { text: 'Installing Kubernetes with deployment tools', 
                          ...
                          items: [
                              { text: 'Bootstrapping clusters with kubeadm', 
                                collapsed: true,
                                items: [
                                  { text: 'Installing kubeadm', link: '/container/k8s/get_started/prod_env/install/bootstrap/install_kubeadm' },
                                  { text: 'Troubleshooting kubeadm', link: '/container/k8s/get_started/prod_env/install/bootstrap/trouble_kubeadm' },
                                  { text: 'Creating a cluster with kubeadm', link: '/container/k8s/get_started/prod_env/install/bootstrap/create_cluster' },
                                  { text: 'Customizing components with the kubeadm API', link: '/container/k8s/get_started/prod_env/install/bootstrap/customize_component' },
                                  { text: 'Options for Highly Available Topology', link: '/container/k8s/get_started/prod_env/install/bootstrap/options_topology' },
                                  { text: 'Creating Highly Available Clusters with kubeadm', link: '/container/k8s/get_started/prod_env/install/bootstrap/create_available_cluster' },
                                  { text: 'Set up a High Availability etcd Cluster with kubeadm', link: '/container/k8s/get_started/prod_env/install/bootstrap/setup_etcd_cluster' },
                                  { text: 'Configuring each kubelet in your cluster using kubeadm', link: '/container/k8s/get_started/prod_env/install/bootstrap/configure_kubelet' },
                                  { text: 'Dual-stack support with kubeadm', link: '/container/k8s/get_started/prod_env/install/bootstrap/dual_stack_support' },
                                ]
                              },
                              { text: 'Installing Kubernetes with kOps', link: '/container/k8s/get_started/prod_env/install/install_k8s_kops' },
                              { text: 'Installing Kubernetes with Kubespray', link: '/container/k8s/get_started/prod_env/install/install_k8s_kubespray' },
                            ] 
                        },
                        { text: 'Turnkey Cloud Solutions', link: '/container/k8s/get_started/prod_env/turnkey' },
                      ] 
                  },
                  { text: 'Best practices', 
                    collapsed: true,
                    items: [
                        { text: 'Considerations for large clusters', link: '/container/k8s/get_started/best_practice/consideration' },
                        { text: 'Running in multiple zones', link: '/container/k8s/get_started/best_practice/run_zone' },
                        { text: 'Validate node setup', link: '/container/k8s/get_started/best_practice/validate_node' },
                        { text: 'Enforcing Pod Security Standards', link: '/container/k8s/get_started/best_practice/enforce_pod' },
                        { text: 'PKI certificates and requirements', link: '/container/k8s/get_started/best_practice/pki_certificate' },
                      ] 
                  },
                ] 
            },
            { text: 'Concepts', 
              collapsed: true,
              items: [
                  { text: 'Introduction', link: '/container/k8s/concept/introduction' },
                  { text: 'Overview', 
                    collapsed: true,
                    items: [
                        { text: 'Overview', link: '/container/k8s/concept/overview/overview' },
                        { text: 'Objects In Kubernetes', 
                          collapsed: true,
                          items: [
                            { text: 'Overview', link: '/container/k8s/concept/overview/object_k8s/overview' },
                            { text: 'Kubernetes Object Management', link: '/container/k8s/concept/overview/object_k8s/k8s_object_manage' },
                            { text: 'Object Names and IDs', link: '/container/k8s/concept/overview/object_k8s/obj_name' },
                            { text: 'Labels and Selectors', link: '/container/k8s/concept/overview/object_k8s/label_selector' },
                            { text: 'Namespaces', link: '/container/k8s/concept/overview/object_k8s/namespace' },
                            { text: 'Annotations', link: '/container/k8s/concept/overview/object_k8s/annotation' },
                            { text: 'Field Selectors', link: '/container/k8s/concept/overview/object_k8s/field_selector' },
                            { text: 'Finalizers', link: '/container/k8s/concept/overview/object_k8s/finalizer' },
                            { text: 'Owners and Dependents', link: '/container/k8s/concept/overview/object_k8s/owner' },
                            { text: 'Recommended Labels', link: '/container/k8s/concept/overview/object_k8s/recommend' },
                          ]
                        },
                        { text: 'Kubernetes Components', link: '/container/k8s/concept/overview/k8s_component' },
                        { text: 'The Kubernetes API', link: '/container/k8s/concept/overview/k8s_api' },
                      ] 
                  },
                  { text: 'Cluster Architecture', 
                    collapsed: true,
                    items: [
                        { text: 'Nodes', link: '/container/k8s/concept/cluster_arch/node' },
                        { text: 'Communication between Nodes and the Control Plane', link: '/container/k8s/concept/cluster_arch/communication' },
                        { text: 'Controllers', link: '/container/k8s/concept/cluster_arch/controller' },
                        { text: 'Leases', link: '/container/k8s/concept/cluster_arch/lease' },
                        { text: 'Cloud Controller Manager', link: '/container/k8s/concept/cluster_arch/cloud_controller' },
                        { text: 'About cgroup v2', link: '/container/k8s/concept/cluster_arch/cgroup' },
                        { text: 'Container Runtime Interface (CRI)', link: '/container/k8s/concept/cluster_arch/container_runtime' },
                        { text: 'Garbage Collection', link: '/container/k8s/concept/cluster_arch/garbage_collection' },
                        { text: 'Mixed Version Proxy', link: '/container/k8s/concept/cluster_arch/mix_version' },
                      ] 
                  },
                  { text: 'Containers', 
                    collapsed: true,
                    items: [
                      { text: 'Overview', link: '/container/k8s/concept/container/overview' },
                      { text: 'Images', link: '/container/k8s/concept/container/image' },
                      { text: 'Container Environment', link: '/container/k8s/concept/container/container_env' },
                      { text: 'Runtime Class', link: '/container/k8s/concept/container/runtime_class' },
                      { text: 'Container Lifecycle Hooks', link: '/container/k8s/concept/container/container_life_hook' },
                    ] 
                  },
                  { text: 'Workloads', 
                    collapsed: true,
                    items: [
                        { text: 'Overview', link: '/container/k8s/concept/workload/overview' },
                        { text: 'Pods', 
                          collapsed: true,
                          items: [
                            { text: 'Overview', link: '/container/k8s/concept/workload/pod/overview' }, 
                            { text: 'Pod Lifecycle', link: '/container/k8s/concept/workload/pod/pod_lifecycle' }, 
                            { text: 'Init Containers', link: '/container/k8s/concept/workload/pod/init_container' }, 
                            { text: 'Disruptions', link: '/container/k8s/concept/workload/pod/disruption' }, 
                            { text: 'Ephemeral Containers', link: '/container/k8s/concept/workload/pod/ephemeral_container' }, 
                            { text: 'Pod Quality of Service Classes', link: '/container/k8s/concept/workload/pod/pod_quality' }, 
                            { text: 'User Namespaces', link: '/container/k8s/concept/workload/pod/user_namespace' }, 
                            { text: 'Downward API', link: '/container/k8s/concept/workload/pod/downward_api' }, 
                          ]
                        },
                        { text: 'workload', 
                          collapsed: true,
                          items: [
                            { text: 'Overview', link: '/container/k8s/concept/workload/workload/overview' }, 
                            { text: 'Deployments', link: '/container/k8s/concept/workload/workload/deployment' }, 
                            { text: 'ReplicaSet', link: '/container/k8s/concept/workload/workload/replicaset' }, 
                            { text: 'StatefulSets', link: '/container/k8s/concept/workload/workload/statefulset' }, 
                            { text: 'DaemonSet', link: '/container/k8s/concept/workload/workload/daemonset' }, 
                            { text: 'Jobs', link: '/container/k8s/concept/workload/workload/job' }, 
                            { text: 'Automatic Cleanup for Finished Jobs', link: '/container/k8s/concept/workload/workload/automatic_cleanup' }, 
                            { text: 'CronJob', link: '/container/k8s/concept/workload/workload/cronjob' }, 
                            { text: 'ReplicationController', link: '/container/k8s/concept/workload/workload/replication_controller' }, 
                          ]
                        }
                    ] 
                  },
                  { text: 'Services, Load Balancing, and Networking', 
                    collapsed: true,
                    items: [
                        { text: 'Overview', link: '/container/k8s/concept/service/overview' },
                        { text: 'Service', link: '/container/k8s/concept/service/service' },
                        { text: 'Ingress', link: '/container/k8s/concept/service/ingress' },
                        { text: 'Ingress Controllers', link: '/container/k8s/concept/service/ingress_controller' },
                        { text: 'EndpointSlices', link: '/container/k8s/concept/service/endpoint_slice' },
                        { text: 'Network Policies', link: '/container/k8s/concept/service/network_policies' },
                        { text: 'DNS for Services and Pods', link: '/container/k8s/concept/service/dns' },
                        { text: 'IPv4/IPv6 dual-stack', link: '/container/k8s/concept/service/ipv4_ipv6' },
                        { text: 'Topology Aware Routing', link: '/container/k8s/concept/service/topology' },
                        { text: 'Networking on Windows', link: '/container/k8s/concept/service/network_windows' },
                        { text: 'Service ClusterIP allocation', link: '/container/k8s/concept/service/service_clusterip' },
                        { text: 'Service Internal Traffic Policy', link: '/container/k8s/concept/service/service_internal' },
                      ] 
                  },
                  { text: 'Storage', 
                    collapsed: true,
                    items: [
                        { text: 'Volumes', link: '/container/k8s/concept/storage/volume' },
                        { text: 'Persistent Volumes', link: '/container/k8s/concept/storage/persistent_volume' },
                        { text: 'Projected Volumes', link: '/container/k8s/concept/storage/project_volume' },
                        { text: 'Ephemeral Volumes', link: '/container/k8s/concept/storage/ephemeral_volume' },
                        { text: 'Storage Classes', link: '/container/k8s/concept/storage/storage_class' },
                        { text: 'Dynamic Volume Provisioning', link: '/container/k8s/concept/storage/dynamic_class' },
                        { text: 'Volume Snapshots', link: '/container/k8s/concept/storage/volume_snapshot' },
                        { text: 'Volume Snapshot Classes', link: '/container/k8s/concept/storage/volume_snapshot_class' },
                        { text: 'CSI Volume Cloning', link: '/container/k8s/concept/storage/csi_volume' },
                        { text: 'Storage Capacity', link: '/container/k8s/concept/storage/storage_capacity' },
                        { text: 'Node-specific Volume Limits', link: '/container/k8s/concept/storage/volume_limit' },
                        { text: 'Volume Health Monitoring', link: '/container/k8s/concept/storage/volume_health' },
                        { text: 'Windows Storage', link: '/container/k8s/concept/storage/windows_storage' },
                      ] 
                  },
                  { text: 'Configuration', 
                    collapsed: true,
                    items: [
                        { text: 'Configuration Best Practices', link: '/container/k8s/concept/configuration/config_best' },
                        { text: 'ConfigMaps', link: '/container/k8s/concept/configuration/configmap' },
                        { text: 'Secrets', link: '/container/k8s/concept/configuration/secret' },
                        { text: 'Resource Management for Pods and Containers', link: '/container/k8s/concept/configuration/resource_management' },
                        { text: 'Organizing Cluster Access Using kubeconfig Files', link: '/container/k8s/concept/configuration/organize_cluster' },
                        { text: 'Resource Management for Windows nodes', link: '/container/k8s/concept/configuration/resource_management_windows' },
                      ] 
                  },
                  { text: 'Security', 
                    collapsed: true,
                    items: [
                        { text: 'Overview of Cloud Native Security', link: '/container/k8s/concept/security/overview' },
                        { text: 'Pod Security Standards', link: '/container/k8s/concept/security/pod_security' },
                        { text: 'Service Accounts', link: '/container/k8s/concept/security/service_account' },
                        { text: 'Pod Security Admission', link: '/container/k8s/concept/security/pod_security_admission' },
                        { text: 'Security For Windows Nodes', link: '/container/k8s/concept/security/security_windows' },
                        { text: 'Controlling Access to the Kubernetes API', link: '/container/k8s/concept/security/control_access' },
                        { text: 'Role Based Access Control Good Practices', link: '/container/k8s/concept/security/role_base_access' },
                        { text: 'Good practices for Kubernetes Secrets', link: '/container/k8s/concept/security/good_practice' },
                        { text: 'Multi-tenancy', link: '/container/k8s/concept/security/multi-tenancy' },
                        { text: 'Kubernetes API Server Bypass Risks', link: '/container/k8s/concept/security/k8s_api' },
                        { text: 'Security Checklist', link: '/container/k8s/concept/security/security_checklist' },
                      ] 
                  },
                  { text: 'Policies', 
                    collapsed: true,
                    items: [
                        { text: 'Overview', link: '/container/k8s/concept/policies/overview' },
                      ] 
                  },
                  { text: 'Scheduling, Preemption and Eviction', 
                    collapsed: true,
                    items: [
                        { text: 'Overview', link: '/container/k8s/concept/schedule/overview' },
                      ] 
                  },
                  { text: 'Cluster Administration', 
                    collapsed: true,
                    items: [
                        { text: 'Overview', link: '/container/k8s/concept/cluster_admin/overview' },
                      ] 
                  },
                  { text: 'Windows in Kubernetes', 
                    collapsed: true,
                    items: [
                        { text: 'Overview', link: '/container/k8s/concept/windows/overview' },
                      ] 
                  },
                  { text: 'Extending Kubernetes', 
                    collapsed: true,
                    items: [
                        { text: 'Overview', link: '/container/k8s/concept/extend_k8s/overview' },
                      ] 
                  },
                ] 
            },
            { text: 'Tasks', 
              collapsed: true,
              items: [
                  { text: 'Overview', link: '/container/k8s/task/overview' },
                ] 
            },
            { text: 'Tutorials', 
              collapsed: true,
              items: [
                  { text: 'Overview', link: '/container/k8s/tutorial/overview' },
                ] 
            },
            { text: 'Reference', 
              collapsed: true,
              items: [
                  { text: 'Overview', link: '/container/k8s/reference/overview' },
                ] 
            },
            { text: 'Contribute', 
              collapsed: true,
              items: [
                  { text: 'Overview', link: '/container/k8s/contribute/overview' },
                ] 
            },
          ]
        }
