...
- If you want to write your own controller, see [Extension Patterns](https://kubernetes.io/docs/concepts/extend-kubernetes/#extension-patterns) in Extending Kubernetes.